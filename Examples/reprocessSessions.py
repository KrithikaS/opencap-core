...
session_ids = [
                ...
                # DAD Sessions
                # '28d05525-05b9-442b-bb83-e4ed0cb65376', # DAD05
                # '01f01c0b-20ae-4296-8947-0556d12f43ee', # DAD06
                # '46095633-852c-48b6-9b96-ac8679febce9', # DAD07
                # 'fe2305c0-956f-4bac-849e-ae5d19786576', # DAD09
                # '3706feac-6f69-4c43-b86a-c67c43d2bde1', # DAD10
                # '6f7d608c-0236-4d56-a373-3a4e1073a3f3', # DAD13
                # '2a8af4cc-4167-42c3-a847-281fb08e4cae', # DAD14
                '5cea95f8-1b61-413b-9237-dbc6d83a1284', # DAD15
            ]
...
dynamic_trialNames = ['rc_l2'] # None (all dynamic trials), [] (skip), or list of trial names
...
batchReprocess(session_ids,calib_id,static_id,dynamic_trialNames,
               ...
               deleteLocalFolder=deleteLocalFolder, cameras_to_use=['all_available'])
